            ...
            if sb:
                ...
                if generate_theme_css_for_brand:
                    try:
                        ...
                        theme_css_light = sanitize_css_block(
                            sb.theme_light_css or brand["theme_css_light"]
                        )
                        theme_css_dark = sanitize_css_block(
                            sb.theme_dark_css or brand["theme_css_dark"]
                        )
                else:
                ...
                brand.update(
                    {
                        ...
                        "font_heading": sanitize_font_family(
                            sb.font_heading or brand["font_heading"]
                        ),
                        "font_body": sanitize_font_family(
                            sb.font_body or brand["font_body"]
                        ),
    ...
    if user_org and (
        ...
        if generate_theme_css_for_brand:
            try:
                ...
                # Fall back to raw CSS if generation fails
                theme_css_light = sanitize_css_block(
                    user_org.theme_light_css or brand["theme_css_light"]
                )
                theme_css_dark = sanitize_css_block(
                    user_org.theme_dark_css or brand["theme_css_dark"]
                )
        else:
            # Fallback if themes module not available
            theme_css_light = sanitize_css_block(
