...
- `/checktick_app/surveys/tests/` - Survey-related webapp tests
  ...
  - `test_survey_builder_workflow.py` - Survey builder workflow (Tier 1–4: sections, unified builder, empty state, rename/delete from rail, Organise page rename, group_builder deprecation, HTMX section switching, Survey Map visualiser route)
