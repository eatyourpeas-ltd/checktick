---
title: "Standard Data Security Clauses"
...
Personnel shall at all times comply with {{ platform_name }}’s internal security framework, specifically the:
...
Upon dismissal, resignation, or the end of a contract period, all access to {{ platform_name }} systems and data shall be revoked immediately.
