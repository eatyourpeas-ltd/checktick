---
title: "Hardware & Removable Media Asset Register"
...
* **Security Baseline:** Every device in this register must have:
    1. Full Disk Encryption (FileVault/BitLocker) enabled.
    2. Strong login passwords and MFA for cloud access.
    3. Automatic OS security updates enabled.
