...
* **Lawful Basis & Principles:** [Consent Policy](./compliance/consent-policy.md) | [Opt-Out Statement](./compliance/opt-out.md)
* **Clinical Confidentiality:** [Caldicott Guardian Statement](./compliance/caldicott-statement.md)
* **Impact Assessments:** [DPIA: Survey Platform](./compliance/dpia-survey-platform.md)
* **Transparency:** [Privacy Policy](https://checktick.uk/docs/privacy-policy/) | [Refund Policy](https://checktick.uk/docs/refund-policy/)
* **Data Mapping:** [Data Flow Mapping](./compliance/data-flow-mapping.md) | [Asset Register](./compliance/asset-register.md)
...
* **Vulnerability Control:** [Vulnerability Management Policy](./compliance/vulnerability-management-policy.md)
...
* **Breach Management:** [Incident Response Plan](./compliance/incident-response-plan.md)
* **Verification Logs:** [Annual DR Test Report](./compliance/annual-disaster-recovery.md) | [Backup Log](./compliance/backup-log.md)

## 4. Individual Rights & Staff Responsibilities

How we interact with data subjects and ensure staff competency.

* **Rights Procedures:** [Individual Rights Procedure](./compliance/individual-rights-procedure.md)
* **Rights Tracking:** [Data Rights Request Tracker](./compliance/data-rights-request-tracker.md)
* **Staff Competency:** [Training & Awareness Log](./compliance/training.md)
* **Board Oversight:** [Board Review Minutes](./compliance/board-suite-minutes-dpst.md)
